...
<div class="main-container">
    ...
    <div class="table-container">
        <table id="table-results">
            ...
            <%
                ArrayList<String> points = (ArrayList<String>) request.getAttribute("points");
            ...
            %>
            <tr <% if ("success".equals(pointData[3])) { %>class="green"<% } %>>
                <td><%= pointData[0] %></td>
                <td><%= pointData[1] %></td>
                <td><%= pointData[2] %></td>
                <td><%= pointData[3] %></td>
                <td><%= pointData[4] %></td>
                <td><%= formatter.format(new Date(Long.parseLong(pointData[5]))) %></td>
            </tr>
            <%
                    }
                }
